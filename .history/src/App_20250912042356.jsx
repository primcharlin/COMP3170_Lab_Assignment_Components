...
export default function App() {
    ...
    if (shortTitleIndex > 0) {
        // Move the short title book to the first position
        const [shortBook] = displayBooks.splice(shortTitleIndex, 1);
        displayBooks.unshift(shortBook);
    }
